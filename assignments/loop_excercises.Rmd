...
The humble for loop is often considered distasteful for many seasoned programmers
because of it is inefficient; however, the for loop is one of the most useful and
