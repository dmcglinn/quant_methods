...
We will use a simple simulated examine with 3 independent variables. 

```{r}
x1 <- rnorm(100)                          # continous variable 1
x2 <- rnorm(100)                          # continous variable 2
...
Let's respecify our model and re-examine the partial residual plot  
