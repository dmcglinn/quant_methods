...
usually have a least one argument and somekind of output. 
...
when the function `help` or `?` is used preceeding a function name. Here is a 
...
#'
#' @return a vector of strings that idicates the class of each column of `x` 
#' @export
#'
#' @examples
#' eval_class(cars)
