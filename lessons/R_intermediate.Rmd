...
## Lesson Outline
* <a href="#rep">Programming for repetive tasks</a>
...
First we have to define an empty object we'll call this dat_classes
...
## <a href="#fun" name="fun">#</a>Functions
...
Above the only change we have made to our for loop is to substitue the object
...
Rstudio has made the debuging experience for R users much better than previously.
