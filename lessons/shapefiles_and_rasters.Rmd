...
world_merc <- st_transform(world_longlat, crs=CRS("+proj=merc"))
# Lambert Azimuthal Equal Area
world_laea <- st_transform(world_longlat, crs=CRS("+proj=laea"))
# sinusoidal
world_sinusoidal <- st_transform(world_longlat, crs=CRS("+proj=sinu"))
