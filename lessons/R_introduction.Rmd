...
need to consider typability and readability when designing the name. A long name
like root_rhiz_prod_total_mm is very clear but is a pain to read and worse to 
type. R has a built-in name compliction system but this doesn't completely 
