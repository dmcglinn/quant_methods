...
Having checked the assumptions and carried out model comparison we can now feel
pretty confident about making some biological conclusions. Our main effect model
received the most empirical support and it suggests that fruit mass increased
due to fertilizer and plant height. The effect of fertilizer was a little stronger
than the effect of height and together these two variables helped to explain 
approximately 50% of the variance in fruit mass. We did not find strong support
that the effects of plant height were changed by if the plant was fertilized or not
(i.e., there was no interaction effect present). 
